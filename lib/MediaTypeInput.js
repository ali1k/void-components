    ...
    _createClass(MediaTypeInput, [{
        ...
        value: function componentDidMount() {
            if (!this.props.noFocus) {
                _reactDom2['default'].findDOMNode(this.refs.mediaTypeInputSelect).focus();
            }
        }
    }, {
        ...
        value: function render() {
            ...
            if (this.state.userDefinedMode) {
                output = _react2['default'].createElement(_ldRComponents.BasicIndividualInput, { placeholder: 'Enter you other format...', spec: { value: '', valueType: this.props.spec.valueType, dataType: this.props.spec.dataType }, config: this.props.config, onDataEdit: this.handleDataEdit.bind(this), onEnterPress: this.handleEnterPress.bind(this), allowActionByKey: '1' });
            } else {
